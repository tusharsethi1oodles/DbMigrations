...
#     # Insert into entity
#     insert_entity_query = """
#     INSERT INTO sample.entity (creator_ledger_id, created_by, updated_by, created_at, updated_at, deleted_at, type, name)
#     SELECT 
#         creator_ledger_id, 
#         created_by, 
#         updated_by, 
...
#     # Get last inserted entity_id
#     cursor_db2.execute("""
#     SELECT entity_id FROM sample.entity
#     ORDER BY entity_id DESC
#     LIMIT 1;
#     """)
#     entity_last = cursor_db2.fetchone()[0]
    
#     # Insert into people
#     insert_people_query = """
#     INSERT INTO sample.people (entity_id, salutation, first_name, last_name, title, date_of_birth, created_by, updated_by, created_at, updated_at, type)
#     SELECT 
#         %s, 
#         salutation, 
#         first_name, 
...
#     #     INSERT INTO sample.entity_property (entity_id, property_id, property_value)
#     #     SELECT %s, '{prop}', {prop}
#     #     FROM dmscopy.global_people
#     #     WHERE id = %s AND {prop} IS NOT NULL;
#     #     """
#     #     cursor_db2.execute(insert_property_query, (entity_last, record_id))
#     #     conn_db2.commit()

#     for prop in properties:
#         cursor_db2.execute("SELECT property_id FROM sample.property WHERE property_id = %s", (prop,))
